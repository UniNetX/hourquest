...
-- Normalize legacy user_type values before adding the stricter check
...
-- Upgrade admin_reorder_challenges to track-aware signature (was category-only on older DBs)
